  ...
  `("<html>"
    ...
    (semantic (:name "section")
	      ...
	      (heading (:name "Concepts" :toc t)
		       ,(cl-html-readme:read-file "makedoc/concepts-introduction.html")
		       ...
		       (heading (:name "Module" :toc t)
				...
				(heading (:name "Example: An adder module" :toc nil)
					 ,(make-code-string "src/synthesizer/examples/module-adder-2.lisp"))
				(heading (:name "Example: A module that exposes an internal state" :toc nil)
					 ,(make-code-string "src/synthesizer/examples/module-expose-state.lisp")))
		       (heading (:name "Rack" :toc t)
				,(cl-html-readme:read-file "makedoc/rack-introduction.html")
				(heading (:name "Example: A rack holding 3 patched adders" :toc nil)
					 ,(make-code-string "src/synthesizer/examples/rack-3-adders.lisp"))
				(heading (:name "Example: A rack that exposes inputs and outputs" :toc nil)
					 ,(make-code-string "src/synthesizer/examples/rack-expose.lisp")))
		       (heading (:name "Composing modules of other modules" :toc t)
				(heading (:name "Example: An adder with 4 inputs" :toc nil)
					 ,(make-code-string "src/synthesizer/examples/module-composed-adder-4.lisp"))))

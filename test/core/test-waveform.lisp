...
(define-test test-waveform-sine-1 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
		 (if (funcall trigger (cl-synthesizer-core:phase-sine-converter (funcall phase-generator 1.0)))
...
(define-test test-waveform-saw-1 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
      (if (funcall trigger (cl-synthesizer-core:phase-saw-converter (funcall phase-generator 1.0)))
	  (setf trigger-count (+ trigger-count 1))))
    ;; 14 zero-crossings
    (assert-equal 14 trigger-count)))
...
(define-test test-waveform-triangle-1 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
		 (if (funcall trigger (cl-synthesizer-core:phase-triangle-converter (funcall phase-generator 1.0)))
		     (setf trigger-count (+ trigger-count 1))))
    ;; 14 zero-crossings
    (assert-equal 14 trigger-count)))
...
(define-test test-waveform-square-1 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
		 (if (funcall trigger (cl-synthesizer-core:phase-square-converter (funcall phase-generator 1.0)))
		     (setf trigger-count (+ trigger-count 1))))
    ;; 14 zero-crossings
    (assert-equal 14 trigger-count)))
...
(define-test test-waveform-square-3 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
		 (if (funcall trigger (cl-synthesizer-core:phase-square-converter (funcall phase-generator 1.0) :duty-cycle 1.0))
		     (setf trigger-count (+ trigger-count 1))))
    ;; 0 zero-crossings
...
(define-test test-waveform-square-4 ()
  ...
  (let ((trigger (funcall #'cl-synthesizer-test::zero-crossing-trigger))
	...
	(trigger-count 0))
    (dotimes (i 7250)
		 (if (funcall trigger (cl-synthesizer-core:phase-square-converter (funcall phase-generator 1.0) :duty-cycle 0.0))
		     (setf trigger-count (+ trigger-count 1))))
    ;; 0 zero-crossings
    (assert-equal 0 trigger-count)))

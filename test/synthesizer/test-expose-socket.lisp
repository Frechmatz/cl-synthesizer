...
(define-test test-expose-socket-simple ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
      ...
      (assert-true (cl-synthesizer-test::is-module-output rack :rack-output-socket-1))
      (assert-true (cl-synthesizer-test::is-module-output rack :rack-output-socket-2))
      (assert-false (cl-synthesizer-test::is-module-output rack :rack-output-socket-3))
      (assert-true (cl-synthesizer-test::is-module-input rack :rack-input-socket-1))
      (assert-true (cl-synthesizer-test::is-module-input rack :rack-input-socket-2))
      (assert-false (cl-synthesizer-test::is-module-input rack :rack-input-socket-3)))))

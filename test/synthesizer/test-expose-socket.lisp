...
(define-test test-expose-socket-simple ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
      ...
      (cl-synthesizer:expose-input-socket rack :rack-input-socket-1 "Module 1" :input-1)
      (cl-synthesizer:expose-input-socket rack :rack-input-socket-2 "Module 1" :input-2)
      (cl-synthesizer:expose-output-socket rack :rack-output-socket-1 "Module 1" :output-1)
      (cl-synthesizer:expose-output-socket rack :rack-output-socket-2 "Module 1" :output-2)
...
(define-test test-expose-socket-unknown-input-module ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-input-socket rack :rack-input-socket-1 "Module 2" :input-1)))))
...
(define-test test-expose-socket-unknown-output-module ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-output-socket rack :rack-output-socket-1 "Module 2" :output-1)))))
...
(define-test test-expose-socket-unknown-input-module-socket ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-input-socket rack :rack-input-socket-1 "Module 1" :XXXXX)))))
...
(define-test test-expose-socket-unknown-output-module-socket ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-output-socket rack :rack-output-socket-1 "Module 1" :XXXXX)))))
...
(define-test test-expose-input-socket-unknown-input ()
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-input-socket rack :rack-input-socket-1 "Module 1" :xxxxxx)))))

(define-test test-expose-output-socket-unknown-module ()
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (expect-assembly-error
      (cl-synthesizer:expose-output-socket rack :rack-output-socket-1 "XXXXX" :output-1))))
...
(define-test test-expose-output-socket-unknown-output ()
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (let ((m1 (cl-synthesizer:add-module
	       ...
	       #'cl-synthesizer-test::pass-through-module)))
      (expect-assembly-error
	(cl-synthesizer:expose-output-socket rack :rack-output-socket-1 "Module 1" :xxxxxx)))))

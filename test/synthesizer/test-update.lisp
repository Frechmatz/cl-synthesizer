...
(defun create-test-rack-simple ()
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    ...
    (let ((found-module-1 (funcall (getf rack :get-module-by-name) "Counter"))
      ...
      (assert-equal "Counter" (funcall (getf rack :get-module-name) found-module-1))
      (assert-equal "Multiplier" (funcall (getf rack :get-module-name) found-module-2)))
    rack))
...
(defun create-test-rack-adder ()
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    ...
    ;; plus 2 default modules of the rack
    (assert-eq 5 (length (funcall (getf rack :modules))))
    (let ((found-module-1 (funcall (getf rack :get-module-by-name) "Counter 1"))
      ...
      (assert-equal "Counter 1" (funcall (getf rack :get-module-name) found-module-1))
      (assert-equal "Counter 2" (funcall (getf rack :get-module-name) found-module-2))
      (assert-equal "Adder" (funcall (getf rack :get-module-name) found-module-3)))
    rack))
...
(defun create-test-rack-recursive ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    ...
    (let ((found-module-1 (funcall (getf rack :get-module-by-name) "Counter"))
      ...
      (assert-true found-module-2)
      (assert-equal "Counter" (funcall (getf rack :get-module-name) found-module-1))
      (assert-equal "Adder" (funcall (getf rack :get-module-name) found-module-2)))
    rack))

...
(define-test test-find-module-1 ()
		 ...
		 (cl-synthesizer:add-module nested-rack "Multiplier 2" #'cl-synthesizer-test::test-module-multiply-by-two)
		 ...
		 (let ((nested-nested-rack (cl-synthesizer:get-module nested-rack "RACK-3-1")))
		   (cl-synthesizer:add-module nested-nested-rack "Multiplier 3" #'cl-synthesizer-test::test-module-multiply-by-two)))

...
;;
(define-test test-monophonic-midi-interface-multiple-events-1 ()
	     (let ((test
		    `(:voice-count 2 :play-mode :PLAY-MODE-POLY
				   :test-cases
				   ((:events (,(cl-synthesizer-midi-event:make-note-on-event 1 64 0)
...
(define-test test-monophonic-midi-interface-multiple-events-2 ()
	     (let ((test
		    `(:voice-count 2 :play-mode :PLAY-MODE-POLY
				   :test-cases
				   ((:events (,(cl-synthesizer-midi-event:make-note-on-event 1 64 0)
...
(define-test test-monophonic-midi-interface-multiple-events-3 ()
	     (let ((test
		    `(:voice-count 2 :play-mode :PLAY-MODE-POLY
				   :test-cases
				   ((:events (,(cl-synthesizer-midi-event:make-note-on-event 1 64 0)
...
(define-test test-monophonic-midi-interface-channel-1 ()
	     (let ((test
...
(define-test test-monophonic-midi-interface-channel-2 ()
	     (let ((test
...
(define-test test-monophonic-midi-interface-gate-retrigger-1 ()
	     (let ((test
		    `(:voice-count 2 :play-mode :PLAY-MODE-POLY
				   :test-cases
				   ((:events (,(cl-synthesizer-midi-event:make-note-on-event 1 32 0))
...
(define-test test-monophonic-midi-interface-gate-retrigger-2 ()
	     (let ((test
		    `(:voice-count 2 :play-mode :PLAY-MODE-POLY
				   :test-cases
				   ((:events (,(cl-synthesizer-midi-event:make-note-on-event 1 32 0))
...
(define-test test-monophonic-midi-interface-update-1 ()
		...
		(list 
		 ...
		 (list :timestamp-milli-seconds 2100
	       ...
	       (cl-synthesizer:add-module
		rack "MIDI-IFC"
		#'cl-synthesizer-modules-midi-monophonic-interface:make-module :voice-count 1)
...
(define-test test-monophonic-midi-interface-update-3 ()
	     (let ((rack (cl-synthesizer:make-rack
			  :environment (cl-synthesizer:make-environment))))
	       ;; Use MIDI sequencer for generation of Gate signals
	       (cl-synthesizer:add-module

...
(defun example ()
  ...
  (let ((rack (cl-synthesizer:make-rack :environment (cl-synthesizer:make-environment))))
    (cl-synthesizer:add-module
     rack "LFO-1"
     #'cl-synthesizer-modules-linear-vco:make-module :v-peak 5 :cv-max 5 :base-frequency 0.5 :f-max 12000)

    (cl-synthesizer:add-module
     rack "VCO-1"
     #'cl-synthesizer-modules-linear-vco:make-module :base-frequency 50 :cv-max 5 :v-peak 5 :f-max 440)

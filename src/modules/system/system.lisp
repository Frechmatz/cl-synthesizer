  ...
  "Creates a module which exposes runtime information of its rack.
   <p>The function has the following parameters:
    ...
    <ul>
       ...
       <li>:milliseconds The point-of-time in milliseconds relative to <code>:ticks</code>.</li>
       <li>:seconds The point-of-time in seconds relative to <code>:ticks</code>.</li>
    </ul></p>"
  (declare (ignore name))
  (let ((ticks -1)
